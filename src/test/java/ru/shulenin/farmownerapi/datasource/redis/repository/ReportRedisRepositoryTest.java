...
public class ReportRedisRepositoryTest extends TestBase implements RedisRepositoryTest {
    private final ReportRedisRepository redisRepository;
    ...
    public void saveAllTest() {
        ...
        List<Report> entities = List.of(entity1, entity2);
    ...
    private boolean checkSize(List<Report> workersFromJpa, List<Report> workersFromRedis) {
