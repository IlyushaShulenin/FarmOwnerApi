...
class ProductRestControllerTest extends TestBase {
    ...
    void findAll() throws Exception {
        ...
        mockMvc.perform(get(getUri("product")))
    ...
    void findById() throws Exception {
        ...
        mockMvc.perform(get(getUri("product/1")))
                .andExpect(status().isOk())
                .andExpect(content().json(found));

        mockMvc.perform(get(getUri("product/100")))
